...
class ManageUsersController extends Controller
{
    public function allUsers()
    {
        ...
        $users = User::where('com',0)->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function allInUsers(){
        $page_title = 'All Users';
        $empty_message = 'No user found';
        $users = User::where('no_bro',0)->where('com',0)->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function exportallUsers(Request $request){
        if ($request->search) {
            ...
            if ($request->page != "Manage Users") {
                ...
                $q = User::where('com',0)->query()->active()->latest()->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Banned Users") {
                $q = User::where('com',0)->query()->banned()->latest()->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Verified Data Users") {
                $q = User::where('com',0)->query()->where('is_kyc','2')->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Waiting For Verification Data Users") {
                $q = User::where('com',0)->query()->where('is_kyc','1')->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Email Unverified Users") {
                $q = User::where('com',0)->query()->emailUnverified()->latest()->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Email Verified Users") {
                $q = User::where('com',0)->query()->emailVerified()->latest()->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }

                if ($request->page == "Rejected Data Users") {
                $q = User::where('com',0)->query()->where('is_kyc','3')->select(db::raw("CONCAT(firstname, ' ',lastname ) AS nama"),'username','no_bro','email');
                return Excel::download(new ExptUserQueryPage($q), 'users.xlsx');
                }
    ...
    public function activeUsers()
    {
        ...
        $users = User::where('com',0)->active()->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function bannedUsers()
    {
        ...
        $users = User::where('com',0)->banned()->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function rejectDataUsers()
    {
        ...
        $users = User::where('com',0)->where('is_kyc','3')->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function verifiedDataUsers()
    {
        ...
        $users = User::where('com',0)->where('is_kyc','2')->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function verificationDataUsers()
    {
        ...
        $users = User::where('com',0)->where('is_kyc','1')->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function emailUnverifiedUsers()
    {
        ...
        $users = User::where('com',0)->emailUnverified()->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    public function emailVerifiedUsers()
    {
        ...
        $users = User::where('com',0)->emailVerified()->latest()->paginate(getPaginate());
        return view('admin.users.list', compact('page_title', 'empty_message', 'users'));
    }
    ...
    public function search(Request $request, $scope)
    {
        ...
        $users = User::where('com',0)->where(function ($user) use ($search) {
    ...
    public function detail($id)
    {
        ...
        $user               = User::where('com',0)->where('id', $id)->with('userExtra')->first();
        $ref_id             = User::where('com',0)->find($user->ref_id);
        $bank = bank::all();
    ...
    public function detailFind(Request $request){
        // dd($request->all());
        $user = User::where('com',0)->where('username','=',$request->search)->first();
        if($user){
    ...
    public function goldDetail($id){
        $user = user::where('com',0)->where('id',$id)->first();
    ...
    {
        // dd($request->all());
        $user = User::where('com',0)->findOrFail($id);
        $request->validate([
