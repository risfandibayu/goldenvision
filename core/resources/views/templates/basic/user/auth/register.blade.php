...
@section('panel')
    ...
    <div class="account-section bg_img"
        ...
        <div class="account__section-wrapper">
            <div class="account__section-content sign-up" style="background-color: #413735">
                <div class="w-100">
                    <div class="logo mb-4">
                        <a href="{{ route('home') }}">
            ...
            @endif --}}
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="firstname" id="firstname" value="{{ old('firstname') }}"
                                autocomplete="off" placeholder="@lang('First Name')*" required
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="lastname" id="lastname" value="{{ old('lastname') }}"
                                placeholder="@lang('Last Name')*" required class="form-control form--control-2">
                        </div>

                        <div class="col-sm-6">
                            <label for="email" class="form--label-2">@lang('Email')</label>
                            <input type="email" name="email" id="email" value="{{ old('email') }}"
                                placeholder="@lang('Email')*" required class="form-control form--control-2">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-custom">
                                ...
                                <input type="text" class="form-control form--control-2" name="mobile"
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="country" id="country" placeholder="@lang('Country')" readonly
                                class="form-control form--control-2">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                placeholder="@lang('Confirm Password')*" class="form-control form--control-2">
                        </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between">
                                    <div class="checkgroup d-flex flex-wrap align-items-center">
                                        ...
                                        @foreach ($policyElements as $item)
                                            <span
                                                href="{{ route('policy.details', [slug(@$item->data_values->title), $item->id]) }}"
                                                class="text--base"> {{ __($item->data_values->title) }} </span>
                                            @if (!$loop->last)
                                                ,&nbsp;
                                            @endif
                                        @endforeach
