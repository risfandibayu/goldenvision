...
@section('panel')
    ...
    <div class="account-section bg_img"
        data-background="{{ getImage('assets/images/frontend/reset_password/' . @$content->data_values->background_image, '1920x1080') }}">
                ...
                <div class="w-100">
                    ...
                    <form class="account--form g-4" method="post" action="{{ route('user.password.verify-code') }}">
                        ...
                        <div class="form-group">
                            <input type="text" name="code" pattern="[0-9]*" class="form-control" maxlength="6"
                                required>
                        </div>
