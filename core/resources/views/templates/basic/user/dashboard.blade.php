...
@section('panel')
    <div class="row mb-4">
        <div class="col-lg-12">
            @if (isset($checkDaily->days) && $checkDaily->days < 100 && auth()->user()->userExtra->d_gold != 1)
            ...
            @else
                <div class="modal fade" id="modalWd" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form onclick="alert('Ups.. this feature will be coming soon')">
                                    @csrf
                                    <div class="container col-md-8">
                                        <h6>Total Emas: {{ nbk($checkDaily->gold) ?? '' }}</h6>
                                        <h6>Harga Emas /Gram: Rp {{ nb($goldBonus) }}</h6>
                                        <h6>-----------------------------------------------</h6>
                                        <h6>Harga Total: Rp{{ nb($goldBonus * $checkDaily->gold) }}</h6>

                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-12 text-sm-center">
                                            <button type="submit" class="btn btn-warning btn-block">Transfer to Balance
                                                Rp {{ nb($goldBonus * $checkDaily->gold) }} <i
                                                    class="me-2 fas fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="alert alert-success alert-dismissible fade show p-3 text-center" role="alert"
                    ...
                    <div>Kamu Sudah Check-In Emas Selama
                        {{ $checkDaily->days ?? '' }} Hari Nih Sebanyak {{ nbk($checkDaily->gold) ?? '' }} Gram,
