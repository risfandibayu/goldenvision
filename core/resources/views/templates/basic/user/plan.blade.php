                                        ...
                                        <div class="modal-body row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="sponsor"
                                                    class="referral form-control form--control-2 @if ($sponsor) is-valid @endif "
                                                    value="{{ $sponsor?->username ?? old('sponsor') }}" id="ref_name"
                                                    placeholder="@lang('Enter Sponsor Username')*" required>
                                                @if ($sponsor)
                                                    <span class="text-success">Success Menerapkan Link Undangan, By Sponsor:
                                                        <b><i>`{{ $sponsor?->username }}`</i></b></span>
                                                @endif
                                            </div>
                                            @if ($sponsor)
                                                <div class="form-group col-6 d-none">
                                                    ...
                                                    <select name="position" id="pos" class="form-control">
                                                        ...
                                                        <option value="1" {{ $pos == 1 ? 'selected' : '' }}>Kiri
                                                        </option>
                                                        <option value="2" {{ $pos == 2 ? 'selected' : '' }}>Kanan
                                                        </option>
                                                    </select>
                                                </div>
                                            @endif
