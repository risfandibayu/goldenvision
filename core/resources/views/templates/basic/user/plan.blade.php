                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{ route('user.plan.purchase') }}">
                            ...
                            <div class="modal-body row">
                                <h5 class="text-center col-12">{{ getAmount($data->price) }} {{ $general->cur_text }} / MP
                                </h5>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input class="form-control" type="number" name="qty" id="qty" min="1"
                                        value="1" placeholder="MP qty" required>
                                </div>
                                <div class="col-6">
                                    <label for="ref_name" class="form--label-2">@lang('Referral MP Number (Sponsor)')</label>
                                    <input type="text" name="sponsor" class="referral form-control form--control-2"
                                        value="{{ old('referral') }}" id="ref_name" placeholder="@lang('Enter Sponsor MP Number')*"
                                        required>
                                </div>
                                <div class="col-6">
