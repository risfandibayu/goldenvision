    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--15 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $bonusr }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Monthly Bonus')</span>
                    </div>
                    <a href="{{ url('/admin/bonus-reward') }}"
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--success b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $bonusa }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Alltime Bonus')</span>
                    </div>
                    <a href="{{ url('/admin/bonus-reward') }}"
                        class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--danger b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $ure }} </span>
                    </div>
                    <div class="desciption">
                        <span>@lang('User Claim')</span>
                    </div>

                    <a href="{{ url('admin/user-reward') }}"
                        class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--warning b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $ure2 }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Bonus Send')</span>
                    </div>
