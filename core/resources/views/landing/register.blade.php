                            ...
                            <form class="section" method="post" action="{{ route('user.register') }}">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-sm-center">
                                        <button type="submit" class="btn btn-dark-primary">Register<i class="uil uil-arrow-right size-22 ml-3"></i></button>
                                    </div>
                                </div>
                                <p class="mt-4 mb-0 text-sm-center size-16">
                                    Already have an account?
                                    <a href="{{ route('user.login') }}" class="link link-dark-primary-2 link-normal animsition-link">
                                        Sign In
                                    </a>
                                </p>
                            </form>
